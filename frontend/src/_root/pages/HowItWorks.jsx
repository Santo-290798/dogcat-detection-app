            ...
            <Row className='justify-content-center'>
                <Col xxl={10} lg={9}>
                    ...
                    <p className='app-description'>
                        Explore the amazing world of object detection with our <span className='highlight-color fw-bold'>Dog&Cat </span>
                    ...
                    <p className='app-description'>
                        Our <span className='highlight-color fw-bold'>Dog&Cat </span>Detection web application leverages cutting-edge <a href='https://docs.ultralytics.com/models/yolov8/' className='highlight-color fst-italic' target='_blank'>YOLOv8</a> technology to provide you with a seamless and powerful object
                    ...
                    <ol className='app-description'>
                        ...
                        <li>
                            <strong>Download Detected Images:</strong> Save the detected images with bounding boxes and labels. The downloaded image file names follow the format: <span className='file-name-format text-nowrap fst-italic'>{'{category}...{image_id}.png'}</span> where <span className='highlight-color fst-italic'>{'{category}'}</span> can be <i>'ADog', 'ACat', or 'BothDog&Cat'</i>. This makes it easy to store and categorize the images into different folders based on the category.
                        </li>
                    </ol>

                    <p className='app-description'>
                        It's that simple! Our <span className='highlight-color fw-bold'>Dog&Cat </span>Detection web application puts the
